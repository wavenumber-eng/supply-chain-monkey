...
/// ```json
///{
///  "description": "Result envelope for manufacturer-part-number search.",
///  "type": "object",
///  "allOf": [
///    {
...
#[derive(::serde::Deserialize, ::serde::Serialize, Clone, Debug)]
#[serde(deny_unknown_fields)]
pub struct ExternalUrnSupplyChainMonkeySchemaV1SearchEnvelope {
    ///Whether SCM returned a cached provider result.
    pub cached: bool,
...
#[derive(::serde::Deserialize, ::serde::Serialize, Clone, Debug)]
#[serde(deny_unknown_fields)]
pub struct ExternalUrnSupplyChainMonkeySchemaV1StreamDoneEvent {
...
///  "anyOf": [
///    {
///      "description": "Search result from one provider.",
///      "$ref": "#/$defs/External_urn_supply_chain_monkey_schema_v1_search_envelope"
///    },
///    {
///      "description": "Terminal marker after all providers complete.",
///      "$ref": "#/$defs/External_urn_supply_chain_monkey_schema_v1_stream_done_event"
///    }
///  ]
///}
/// ```
...
#[derive(::serde::Deserialize, ::serde::Serialize, Clone, Debug)]
#[serde(deny_unknown_fields)]
pub struct StreamSearchEvent {
    #[serde(flatten, default, skip_serializing_if = "::std::option::Option::is_none")]
    pub subtype_0: ::std::option::Option<
        ExternalUrnSupplyChainMonkeySchemaV1SearchEnvelope,
    >,
    #[serde(flatten, default, skip_serializing_if = "::std::option::Option::is_none")]
    pub subtype_1: ::std::option::Option<
        ExternalUrnSupplyChainMonkeySchemaV1StreamDoneEvent,
    >,
}
impl ::std::default::Default for StreamSearchEvent {
    fn default() -> Self {
        Self {
